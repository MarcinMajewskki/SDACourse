...
public class TeamLeader extends Employee {
    ...
    public TeamLeader(int id, String name, String surname, long pesel, String city, String street, int postcode, Department department) {
        super(id, name, surname, pesel, city, street, postcode, department, EmployeeRole.TEAM_LEADER);
    }
